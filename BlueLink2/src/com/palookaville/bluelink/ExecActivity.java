...
public class ExecActivity extends Activity {
	...
	private void init(){
		...
		scriptListAdapter = new ArrayAdapter<String>(this, R.layout.simplerow, config.externalScriptList());  
...
//        	Toast.makeText(getApplicationContext(), "onStatusClick()", Toast.LENGTH_SHORT).show();
        ...
        case R.id.action_pair: 
        	btLink.pair(this, btShowState); 
        	break;
        case R.id.action_link: 
    		btLink.activate(this, btShowState); 
        	break;
    ...
    private Callback btShowState = new Callback(){
